    ...
    public static String generateJwtToken(UserDetailsImpl userDetails) {
        ...
        try {
            token = JWT.create()
                    ...
                    .withClaim(CLAIM_PET_NAME, userDetails.getUser().getDogName())
                    .withClaim(CLAIM_PET_SIZE, String.valueOf(userDetails.getUser().getPetSizeType()))
                    .withClaim(CLAIM_PET_GENDER, String.valueOf(userDetails.getUser().getDogGender()))
                    .withClaim(CLAIM_PET_AGE, userDetails.getUser().getAnimalAge())
